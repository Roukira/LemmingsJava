...
public class Input implements MouseListener,MouseMotionListener{
	...
	public boolean lemmingsInRange(Lemmings l){
		if (l.getInWorld() && l.getPosY()-1.5*l.getHeight()<posYmouse  && l.getPosY()+(0.5*l.getHeight())>posYmouse && l.getPosX()-1*l.getWidth()<posXmouse  && l.getPosX()+1*l.getWidth()>posXmouse) return true;
		return false;
	}
